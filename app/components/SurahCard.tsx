    ...
    <Link href={`/surah/${surah.slug.slug}`}>
      <div className="group p-4 border rounded-lg border-gray-200 bg-white hover:border-blue-500 hover:bg-blue-50 duration-100 ease-in-out">
        <div className="flex flex-row items-center gap-2">
          <p className="text-lg size-8 rounded-full bg-gray-50 flex items-center justify-center font-medium font-surah group-hover:bg-blue-100 group-hover:text-blue-500">{convertToArabicNumber(surah.id)}</p>
